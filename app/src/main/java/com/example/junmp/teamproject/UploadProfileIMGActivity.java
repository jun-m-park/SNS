...
public class UploadProfileIMGActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String UPLOAD_URL = "http://52.78.243.205/ProfileImageUpload.php";
